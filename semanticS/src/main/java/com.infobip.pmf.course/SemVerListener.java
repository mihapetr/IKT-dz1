...
public interface SemVerListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link SemVerParser#compilationUnit}.
	 * @param ctx the parse tree
	 */
	void enterCompilationUnit(SemVerParser.CompilationUnitContext ctx);
	/**
	 * Exit a parse tree produced by {@link SemVerParser#compilationUnit}.
	 * @param ctx the parse tree
	 */
	void exitCompilationUnit(SemVerParser.CompilationUnitContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SemVerParser#number}.
	 * @param ctx the parse tree
	 */
	void enterNumber(SemVerParser.NumberContext ctx);
	/**
	 * Exit a parse tree produced by {@link SemVerParser#number}.
	 * @param ctx the parse tree
	 */
	void exitNumber(SemVerParser.NumberContext ctx);
	/**
	 * Enter a parse tree produced by {@link SemVerParser#nonzero}.
	 * @param ctx the parse tree
	 */
	void enterNonzero(SemVerParser.NonzeroContext ctx);
	/**
	 * Exit a parse tree produced by {@link SemVerParser#nonzero}.
	 * @param ctx the parse tree
	 */
	void exitNonzero(SemVerParser.NonzeroContext ctx);
	/**
	 * Enter a parse tree produced by {@link SemVerParser#anum}.
	 * @param ctx the parse tree
	 */
	void enterAnum(SemVerParser.AnumContext ctx);
	/**
	 * Exit a parse tree produced by {@link SemVerParser#anum}.
	 * @param ctx the parse tree
	 */
	void exitAnum(SemVerParser.AnumContext ctx);
	/**
	 * Enter a parse tree produced by {@link SemVerParser#zero}.
	 * @param ctx the parse tree
	 */
	void enterZero(SemVerParser.ZeroContext ctx);
	/**
	 * Exit a parse tree produced by {@link SemVerParser#zero}.
	 * @param ctx the parse tree
	 */
	void exitZero(SemVerParser.ZeroContext ctx);
}